...
export const emptyData = () => ({ version: 1, accounts: [], categories: [], transactions: [], budgets: [], bills: [], goals: [], holdings: [], loans: [], tags: [], events: [], snapshots: [], attachments: [], widgets: [], notifications: [], settings: { primaryCurrency: 'USD', currencies: ['USD'], rates: { USD: '1' }, locale: 'en-US', dateFormat: 'medium', monthStart: 1, theme: 'system', timezone: Intl.DateTimeFormat().resolvedOptions().timeZone, aiEnabled: true, ollamaUrl: 'http://192.168.0.133:11434', ollamaModel: 'qwen3:4b', budgetWarning: 80, overviewInsightsLimit: 2, overviewSpendingLimit: 2, overviewBudgetsLimit: 2, overviewGoalsLimit: 2, overviewBillsLimit: 2 } });
export const demoData = () => ({
  version: 1,
  settings: { primaryCurrency: 'LKR', currencies: ['LKR', 'USD'], rates: { LKR: '1', USD: '302.50' }, locale: 'en-LK', dateFormat: 'medium', monthStart: 1, theme: 'system', timezone: 'Asia/Colombo', aiEnabled: true, ollamaUrl: 'http://192.168.0.133:11434', ollamaModel: 'qwen3:4b', budgetWarning: 80, overviewInsightsLimit: 2, overviewSpendingLimit: 2, overviewBudgetsLimit: 2, overviewGoalsLimit: 2, overviewBillsLimit: 2 },
  accounts: [
